...
import os
import numpy as np
from gibson2.core.render.mesh_renderer.mesh_renderer_cpu import MeshRenderer, SwitchableMaterial
...
def main():
    ...
    mtl.load_images(renderer, ['/home/fei/Downloads/woods/WoodFloor15_col.png',
        '/home/fei/Downloads/woods/WoodFloor16_col.png',
        '/home/fei/Downloads/woods/WoodFloor17_col.png',
        '/home/fei/Downloads/woods/WoodFloor18_col.png'])


    renderer.load_object(os.path.join(get_model_path('Rs'), 'mesh_z_up.obj'))
    renderer.add_instance(0)

    renderer.load_object(model_path, material_override=mtl, scale=[3,3,3])
    renderer.add_instance(1)

    renderer.instances[1].set_position([0,1,1])
