...
class InstanceGroup(object):
    ...
    def dump(self):
        ...
        for i, visual_obj in enumerate(self.objects):
            for vertex_data_index, face_data_index in zip(
                visual_obj.vertex_data_indices, visual_obj.face_indices
            ):
...
class Instance(object):
    ...
    def dump(self):
        ...
        vertices_info = []
        faces_info = []
        for vertex_data_index, face_index in zip(
            self.object.vertex_data_indices, self.object.face_indices
        ):
            vertices_info.append(
                transform_vertex(
                    self.renderer.vertex_data[vertex_data_index],
