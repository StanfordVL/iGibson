    ...
    def __init__(
        ...
        class Skill_controller(threading.Thread):
            ...
            def run(self):
                ...
                button_pick = tk.Button(self.root, text='Pick', width=20, height=3, bg='#0052cc', fg='#ffffff', command=button_pick_cammand)
                button_pick.pack()

                def button_place_cammand():
                    self.skill_mode = "Place"
                    label.config(text=self.skill_mode)
                button_pick = tk.Button(self.root, text='Place', width=20, height=3, bg='#0052cc', fg='#ffffff', command=button_place_cammand)
                button_pick.pack()

                def button_toggle_cammand():
                    self.skill_mode = "Toggle"
                    label.config(text=self.skill_mode)
                button_toggle = tk.Button(self.root, text='Toggle', width=20, height=3, bg='#0052cc', fg='#ffffff', command=button_toggle_cammand)
                button_toggle.pack()

                def button_push_cammand():
                    self.skill_mode = "Push"
                    label.config(text=self.skill_mode)
                button_push = tk.Button(self.root, text='Push', width=20, height=3, bg='#0052cc', fg='#ffffff', command=button_push_cammand)
                button_push.pack()

                def button_pull_cammand():
                    self.skill_mode = "Pull"
                    label.config(text=self.skill_mode)
                button_pull = tk.Button(self.root, text='Pull', width=20, height=3, bg='#0052cc', fg='#ffffff', command=button_pull_cammand)
                button_pull.pack()
