...
def main():
    ...
    result = benchmark_rendering(scenes, rendering_settings, modalities)
    ...
    for rendering_setting in rendering_settings:
        for modality in modalities:
            ...
            aggregated_result[("MEAN", rendering_setting, modality)] = np.mean(
                all_scenes
            )
    ...
    plt.tight_layout()
    plt.barh(
        ["-".join(item) for item in aggregated_result.keys()],
