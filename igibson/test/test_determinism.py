import tempfile
import bddl
from igibson.examples.demo.vr_demos.atus import (
    behavior_demo_collection,
    behavior_demo_replay,
)
import igibson
import os
...
def test_determinism_with_new_demo():
    ...
    with tempfile.TemporaryDirectory() as directory:
        ...
        behavior_demo_replay.safe_replay_demo(
            demo_file, out_log_path=replay_file, no_vr=True
        )
