...
lunch_pack_folder = os.path.join(
    igibson.assets_path, "dataset", "processed", "pack_lunch"
)
lunch_pack_files = {
    "sandwich": os.path.join(
        lunch_pack_folder, "food", "cereal", "cereal01", "rigid_body.urdf"
    ),
    "chip": os.path.join(
    ...
    "bread": os.path.join(
        lunch_pack_folder, "food", "granola", "granola00", "rigid_body.urdf"
    ),
    "yogurt": os.path.join(
        lunch_pack_folder,
        "food",
