...
#ifndef RESONANCE_AUDIO_PLATFORM_WWISE_WWISE_RENDERER_PLUGIN_H_
#define RESONANCE_AUDIO_PLATFORM_WWISE_WWISE_RENDERER_PLUGIN_H_
...
class WwiseRendererPlugin : public AK::Wwise::DefaultAudioPluginImplementation {
 public:
  WwiseRendererPlugin();
...
#endif  // RESONANCE_AUDIO_PLATFORM_WWISE_WWISE_RENDERER_PLUGIN_H_
