...
WwiseRoomEffectsPlugin::WwiseRoomEffectsPlugin()
    : property_set_(nullptr), property_view_(nullptr) {}

void WwiseRoomEffectsPlugin::Destroy() {
...
void WwiseRoomEffectsPlugin::SetPluginPropertySet(
    IPluginPropertySet* property_set) {
  property_set_ = property_set;
}

HINSTANCE WwiseRoomEffectsPlugin::GetResourceHandle() const {
  AFX_MANAGE_STATE(AfxGetStaticModuleState());
  return AfxGetStaticModuleState()->m_hCurrentResourceHandle;
}

bool WwiseRoomEffectsPlugin::GetDialog(
...
bool WwiseRoomEffectsPlugin::WindowProc(IAudioPlugin::eDialog dialog,
...
bool WwiseRoomEffectsPlugin::GetBankParameters(const GUID& platform_guid,
