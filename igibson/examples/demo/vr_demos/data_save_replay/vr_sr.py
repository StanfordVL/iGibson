...
from igibson.utils.ig_logging import IGLogWriter, IGLogReader
...
def run_action_sr(mode):
    ...
    if not is_save:
        vr_settings = VrSettings(
            config_str=IGLogReader.read_metadata_attr(
                VR_LOG_PATH, "/metadata/vr_settings"
            )
        )
    ...
    objects = [
        (
            "jenga/jenga.urdf",
            (1.300000, -0.700000, 0.750000),
            (0.000000, 0.707107, 0.000000, 0.707107),
        ),
        (
            "jenga/jenga.urdf",
            (1.200000, -0.700000, 0.750000),
            (0.000000, 0.707107, 0.000000, 0.707107),
        ),
        (
            "jenga/jenga.urdf",
            (1.100000, -0.700000, 0.750000),
            (0.000000, 0.707107, 0.000000, 0.707107),
        ),
        (
            "jenga/jenga.urdf",
            (1.000000, -0.700000, 0.750000),
            (0.000000, 0.707107, 0.000000, 0.707107),
        ),
        (
            "jenga/jenga.urdf",
            (0.900000, -0.700000, 0.750000),
            (0.000000, 0.707107, 0.000000, 0.707107),
        ),
        (
            "jenga/jenga.urdf",
            (0.800000, -0.700000, 0.750000),
            (0.000000, 0.707107, 0.000000, 0.707107),
        ),
        (
            "table/table.urdf",
        ...
        (
            "duck_vhacd.urdf",
            (1.050000, -0.500000, 0.700000),
            (0.000000, 0.000000, 0.707107, 0.707107),
        ),
        (
            "duck_vhacd.urdf",
            (0.950000, -0.100000, 0.700000),
            (0.000000, 0.000000, 0.707107, 0.707107),
        ),
        (
            "sphere_small.urdf",
            (0.850000, -0.400000, 0.700000),
            (0.000000, 0.000000, 0.707107, 0.707107),
        ),
        (
            "duck_vhacd.urdf",
            (0.850000, -0.400000, 1.00000),
            (0.000000, 0.000000, 0.707107, 0.707107),
        ),
    ]
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--mode", default="save", help="Mode to run in: either save or replay"
    )
