...
def main():
    ...
    scene = InteractiveIndoorScene(
        "Rs_int",
        load_object_categories=benchmark_names,
        load_room_types=["kitchen", "lobby"],
    )
    ...
    table_objects_to_load = {
        "tray": {
            "urdf": os.path.join(
                igibson.ig_dataset_path, "objects", "tray", "tray_000", "tray_000.urdf"
            ),
        ...
        "chip_1": {
            "urdf": os.path.join(
                igibson.ig_dataset_path, "objects", "chip", "40", "40.urdf"
            ),
        ...
        "cherry_1": {
            "urdf": os.path.join(
                igibson.ig_dataset_path, "objects", "cherry", "02_0", "02_0.urdf"
            ),
        ...
        "wine_bottle_1": {
            "urdf": os.path.join(
                igibson.ig_dataset_path, "objects", "wine_bottle", "23_1", "23_1.urdf"
            ),
