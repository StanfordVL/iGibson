...
def main():
    ...
    parser.add_argument(
        "--save_dir", type=str, help="Directory to save the frames.", default="misc"
    )
    parser.add_argument("--seed", type=int, default=15, help="Random seed.")
    parser.add_argument("--domain_rand", dest="domain_rand", action="store_true")
    parser.add_argument(
        "--domain_rand_interval", dest="domain_rand_interval", type=int, default=50
    )
    ...
    traj_path = os.path.join(
        get_ig_scene_path(args.scene), "misc", "tour_cam_trajectory.txt"
    )
