...
def run_check_sampling(
    ...
    initial_conditions = (
        initial_conditions if initial_conditions is not None else INITIAL_CONDITIONS
    )
    goal_conditions = (
        goal_conditions if goal_conditions is not None else GOAL_CONDITIONS
    )
