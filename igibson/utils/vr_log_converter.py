...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        required=True,
        type=str,
        help="Input file to convert to time ordered hdf5",
    )
    parser.add_argument(
        "--output", required=True, type=str, help="Output file to write converted data"
    )
    ...
    assert pathlib.Path(
        args.output
    ).parent.exists(), "Error, output directory does not exist"
