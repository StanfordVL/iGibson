...
with open(
    os.path.join(igibson.ig_dataset_path, "metadata/non_sampleable_categories.txt")
) as f:
...
NamedRenderingPresets = {
    ...
    "PBR_SHADOW_MSAA": MeshRendererSettings(
        enable_pbr=True, enable_shadow=True, msaa=True
    ),
    "NO_PBR_OPT": MeshRendererSettings(
        enable_pbr=False, enable_shadow=False, optimized=True
    ),
    "PBR_NOSHADOW_OPT": MeshRendererSettings(
        enable_pbr=True, enable_shadow=True, optimized=True
    ),
    "PBR_SHADOW_MSAA_OPT": MeshRendererSettings(
        enable_pbr=True, enable_shadow=True, msaa=True, optimized=True
    ),
    ...
    "VISUAL_RL": MeshRendererSettings(
        enable_pbr=True, enable_shadow=False, msaa=False, optimized=True
    ),
