class dataset:
    def __init__(self, scene, sim2real=False):
        ...
        if scene == 'igibson':
            if not sim2real:
                ...
                self.SCENE_SPLITS = {
                    "train": ["Pomaria_1_int", "Benevolence_2_int", "Beechwood_1_int", "Ihlen_0_int", "Benevolence_1_int", 
                            "Pomaria_2_int", "Merom_1_int", "Ihlen_1_int", "Wainscott_0_int", "Merom_1_int", "Beechwood_0_int", "Wainscott_1_int", "Merom_0_int", "Rs_int", "Pomaria_0_int"],  # "Benevolence_0_int"], 
                    "val": ["Merom_1_int", "Beechwood_0_int", "Wainscott_1_int", "Merom_0_int", "Rs_int", "Pomaria_0_int"]
                }
        ...
        if scene == 'gibson' or scene == 'mp3d':
            self.SCENE_SPLITS = {
                'train': ['sT4fr6TAbpF', 'E9uDoFAP3SH', 'VzqfbhrpDEA', 'kEZ7cmS4wCh', '29hnd4uzFmX', 'ac26ZMwG7aT',
                          ...
                          '17DRP5sb8fy', '5q7pvUzZiYa', 'VVfe2KiqLaN', 'Vvot9Ly1tCj', 'ULsKaCPVFJR', 
                          'uNb9QFRL6hY', 'ZMojNkEp431', '2n8kARJN3HM', 'vyrNrziPKCB', 'r1Q1Z4BcV1o',
                          'PX4nDJXEHrG', 'b8cTxDM8gDG', 'GdvgFV5R1Z5', 'jh4fc5c5qoQ',
                ...
                'val': ['x8F5xyUWy9e', 'QUCTc6BB5sX', 'EU6Fwq7SyZv', '2azQ1b91cZZ', 'Z6MFQCViBuw', 'pLe4wQe7qrG',
                        'oLBMNvg9in8', 'zsNo4HB9uLZ', 'TbHJrupSAjP', '8194nk5LbLH', 'pa4otMbVnkk', 
                        'yqstnuAEVhm', '5ZKStnWn8Zo', 'Vt2qJdWjCF2', 'wc2JMjhGNzB', 'WYY7iVyf5p8',
                         'fzynW3qQPVF', 'UwV83HsGsw3', 'q9vSo1VnCiC', 'ARNzJeq3xxb', 'gYvKGZ5eRqb',
                         'YFuZgdQ5vWj', 'jtcxE69GiFV'],
