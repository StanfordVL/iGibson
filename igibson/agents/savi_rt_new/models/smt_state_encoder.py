...
class SMTStateEncoder(nn.Module):
    ...
    def __init__(
        ...
        if pose_indices is not None:
            ...
            self.pose_encoder = nn.Linear(5, 16) #get_embedder(10)
    ...
    def _encode_pose(self, agent_pose, memory_pose):
        ...
        # Encode pose
        agent_pose_encoded = self.pose_encoder(agent_pose_formatted) #agent_rel_pose)
