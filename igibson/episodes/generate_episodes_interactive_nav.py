...
if __name__ == "__main__":
    ...
    for split in dataset_split:
        for scene_id in dataset_split[split]:
            ...
            # Load the simulator
            env = iGibsonEnv(
                config_file=env_config, mode="headless", action_timestep=1.0 / 10.0, physics_timestep=1.0 / 240.0
            )

            episode_config = InteractiveNavEpisodesConfig(
                scene_id=env.scene.scene_id, num_episodes=num_episodes, numpy_seed=numpy_seed
            )
            ...
            for episode_index in range(num_episodes):
                ...
                episode_info["interactive_objects_idx"] = env.task.interactive_objects_idx.tolist()
