...
# Add text to scene
text_1_start = [500, 800]
text_1 = s.add_text(text_data='iGibson Text!', pos=text_1_start, scale=1.5, color=[0, 0, 1])

text_2_start = [500, 500]
text_2 = s.add_text(text_data='IS AWESOME!', pos=text_2_start, scale=2.0, color=[1, 0, 0])
...
while True:
    ...
    text_1_new_pos = [text_1_start[0] + 400 * t1, text_1_start[1]]
    text_2_new_pos = [text_2_start[0], text_2_start[1] + 300 * t2]
