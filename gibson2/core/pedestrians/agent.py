...
from core.pedestrians.action import ActionXY, ActionRot
from core.pedestrians.state import ObservableState, FullState

class Agent(object):
    def __init__(self, config, section, time_step, policy='orca'):
        """
        ...
        self.policy = policy_factory[policy](time_step)
        self.px = None
        self.py = None
        self.gx = None
        self.gy = None
