...
def main(args):
    scene_names = ['Beechwood_0_int', 'Beechwood_1_int','Benevolence_1_int','Ihlen_0_int','Merom_0_int','Pomaria_0_int','Pomaria_2_int',
                   'Wainscott_0_int','Benevolence_0_int','Benevolence_2_int','Ihlen_1_int','Merom_1_int',
    ...
    for scene_name in all_scene_names:
        ...
        support_categories = ['dining_table', 'desk', 'pedestal_table', 'gaming_table', 'stand', 'console_table', 'coffee_table',
                              'fridge', 'countertop', 'top_cabinet', 'bookshelf', 'bottom_cabinet',
                              'bottom_cabinet_no_top', 'coffee_table', 'carpet']
        simulator = s
        ...
        for category, count in objects_to_sample:
            ...
            for i in range(count):
                ...
                urdf_object = URDFObject(urdf_path, name=name, category=category, overwrite_inertial=True,
                                         avg_obj_dims=avg_category_spec.get(category), fit_avg_dim_volume=True)
