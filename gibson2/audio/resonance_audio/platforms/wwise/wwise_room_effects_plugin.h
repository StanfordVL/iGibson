...
#ifndef RESONANCE_AUDIO_PLATFORM_WWISE_WWISE_ROOM_EFFECTS_PLUGIN_H_
#define RESONANCE_AUDIO_PLATFORM_WWISE_WWISE_ROOM_EFFECTS_PLUGIN_H_
...
class WwiseRoomEffectsPlugin
    : public AK::Wwise::DefaultAudioPluginImplementation {
 public:
  WwiseRoomEffectsPlugin();
...
#endif  // RESONANCE_AUDIO_PLATFORM_WWISE_WWISE_ROOM_EFFECTS_PLUGIN_H_
