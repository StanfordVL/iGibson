...
class VrAgent(object):
    ...
    """
    def __init__(self, sim, agent_num=1, use_constraints=False, hands=['left', 'right'], use_body=True, use_gaze_marker=True, use_gripper=False, normal_color=True, use_hand_prim=True):
        """
        Initializes VR body:
        ...
        if self.use_body:
            self.vr_dict['body'] = VrBody(self.sim, normal_color=self.normal_color, agent_num=self.agent_num)
    ...
    def set_colliders(self, enabled=0):
...
class VrBody(ArticulatedObject):
    ...
    as other VR users.
    """
    def __init__(self, s, normal_color=True, agent_num=1):
        self.sim = s
        self.normal_color = normal_color
        ...
        self.scaled_bbxc_in_blf = np.array([0, 0, 0])
        self.model_path = self.vr_body_fpath
    ...
    def set_colliders(self, enabled=0):
        ...
        set_all_collisions(self.body_id, enabled)
        if enabled == 1:
...
class VrHand(VrHandBase):
    ...
    def __init__(self, s, hand='right', normal_color=True, use_prim=True, agent_num=1):
        ...
        if self.enable_ghost_hand:
            ...
            self.ghost_hand.category = "ignore"
