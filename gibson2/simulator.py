...
class Simulator:
    ...
    def __init__(self,
        ...
        self.num_phys_steps = max(1, int(self.fixed_frame_dur/self.physics_timestep))
    ...
    def load(self):
        ...
        if self.render_to_tensor:
            ...
            self.renderer = MeshRendererVR(rendering_settings=self.rendering_settings, vr_settings=self.vr_settings)
        else:
