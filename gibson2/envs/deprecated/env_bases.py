...
from gibson2.core.physics.scene_building import SinglePlayerBuildingScene
...
class BaseEnv(gym.Env):
    ...
    def create_single_player_building_scene(self):
        return SinglePlayerBuildingScene(self.robot,
    ...
    def create_single_player_stadium_scene(self):
        return SinglePlayerStadiumScene(self.robot,
                                        gravity=9.8,
                                        timestep=self.timestep,
                                        frame_skip=self.frame_skip,
                                        env=self)
    ...
    def set_window(self, posX, posY, sizeX, sizeY):
        ...
        cmd = 'wmctrl -r \"Bullet Physics\" -e {gravity},{posX},{posY},{sizeX},{sizeY}'.format(
            **values)
        os.system(cmd)
