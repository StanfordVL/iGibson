...
class MotionPlanningBaseArmEnv(NavigateRandomEnv):
    def __init__(self,
        ...
        self.robot_footprint_radius = 0.2
    ...
    def get_local_occupancy_grid(self):
        ...
        scan_local = unit_vector_local[:, :2] * scan[:, None] * laser_linear_range - laser_in_base_frame[:2]
        ...
        cv2.circle(occupancy_grid, (self.grid_resolution // 2, self.grid_resolution // 2), int(self.robot_footprint_radius_in_map), 1,
                   -1)
