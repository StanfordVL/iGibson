...
class NavigateEnv(BaseEnv):
    ...
    def step(self, action):
        ...
        before_position = self.get_position_of_interest()
        cache = self.before_simulation()
        collision_links = self.run_simulation()
        self.after_simulation(cache, collision_links)
        after_position = self.get_position_of_interest()

        self.path_length += np.linalg.norm(after_position - before_position)
